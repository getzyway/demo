<div class="col-sm-3 col-md-2 sidebar">
  ...
  <div class="drop-navigation">
          ...
          <li>
            ...
            <li>
              ...
              <li>
                ...
                <!-- script-for-menu -->
                <script>
                  $( "li a.menu7" ).click(function() {
                  $( "ul.cl-effect-7" ).slideToggle( 300, function() {
                  // Animation complete.
                  });
                  });
                </script>
                ...
                <li>
                  ...
                  <!-- script-for-menu -->
                  <script>
                    $( "li a.menu8" ).click(function() {
                    $( "ul.cl-effect-8" ).slideToggle( 300, function() {
                    // Animation complete.
                    });
                    });
                  </script>
                  ...
                  <li>
                    ...
                    <!-- script-for-menu -->
                    <script>
                      $( "li a.menu9" ).click(function() {
                      $( "ul.cl-effect-9" ).slideToggle( 300, function() {
                      // Animation complete.
                      });
                      });
                    </script>
    ...
    <div class="side-bottom">
      ...
      <div class="copyright">
        <p>Copyright © 2016 elearning Mitrphol. All Rights Reserved</p>
      </div>
    </div>
    -->
